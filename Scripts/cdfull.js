...
var ENV_SBX = {
  ...
  MoviesCategoryID: "7855",
  TVCategoryID: "",
  MostPopularCategoryID: "8376",
  CollectionsCategoryID: "8401",
  NewReleasesCategoryID: "8406",
  KidsCategoryID: "8407"
},
ENV_STG = {
  ...
  MoviesCategoryID: "5704",
  TVCategoryID: "",
  MostPopularCategoryID: "5717",
  CollectionsCategoryID: "5720",
  NewReleasesCategoryID: "5721",
  KidsCategoryID: "5719"
},
ENV_PRD = {
	SystemId: "5f156aa0-c733-43bb-9b6c-992f1bdaca1f",
  ChannelId: "4b37d78a-ab6d-443b-b91b-5de2500e004c",
  ...
  LoginURL: "https://custom.contentdirect.tv/Eastlink/SAML/index.php?ReturnUrl=",
  LogoutURL: "https://custom.contentdirect.tv/Eastlink/SAML/logout.php?ReturnUrl=",
  MoviesCategoryID: "4411",
  TVCategoryID: "",
  MostPopularCategoryID: "4485",
  CollectionsCategoryID: "8401",
  NewReleasesCategoryID: "4483",
  KidsCategoryID: "4484"
}; 
...
$.cd.beforeInitialize(function (){ 
	//Define HTML Player Version
 	$.cd.set_htmlPlayerVersion("v15.3.1.3");
 	//Define Player CDN Location
 	$.cd.set_htmlPlayerServer("http://app.contentdirect.tv/Storefront/");
...
cd.flexUIReady(function () {
    ...
    // If redirecting to login and session NOT expired redirect to Eastlink SSO
		...
		else if (query != null && typeof query != "undefined" && query.search("sessionExpired") > 0) {
			window.location.href = env.LogoutURL + "http://" + clientUrl + "sessionExpired.html";
		}
	  ...
	  '<div class="headerWrapper _full">'+
	  	'<div class="header">'+
	  		'<div class="headerLinks">'+
		  		...
		  		'<a class="movieLink notMobile" href="http://' + clientUrl + 'browseMovie.html">Movies</a>'+
		  		'<a class="popularLink notMobile" href="http://' + clientUrl + 'browsePopular.html">Most Popular</a>'+
		  		'<a class="newReleasesLink notMobile" href="http://' + clientUrl + 'browseNewReleases.html">New Releases</a>'+
		  		'<a class="kidsLink notMobile" href="http://' + clientUrl + 'browseKids.html">Kids</a>'+
		  		//'<a class="tvLink" href="http://' + clientUrl + 'browseTV.html">TV</a>'+
		  		'<div class="_anonymous clearfix notMobile ">'+
		  		...
		  		'</div>'+
		      '<div class="topnav headerButtons _authenticated notMobile clearfix" style="display: none">' +
		        ...
		        '</div>'+		  			
					'</div>'+
					'<div class="searchButtonContainer notMobile"><input type="text" id="anonymousMenuKeyword" class="menu-search-box form-control input-sm" maxlength="50" name="anonymousMenuKeyword" placeholder="Search For a Title"><a><i class="fa fa-search"></i></a></div>' +
		  		...
		  		'<div class="mobileMenu" style="display:none">'+
		  			'<div class="mobileMenuDropDown"><i class="fa fa-bars"></i></div>'+
		  			'<div class="mobileMenuDropDownList" style="display:none">'+
		  				'<a class="movieLink" href="http://' + clientUrl + 'browseMovie.html">Movies</a>'+
				  		'<a class="popularLink" href="http://' + clientUrl + 'browsePopular.html">Most Popular</a>'+
				  		'<a class="newReleasesLink" href="http://' + clientUrl + 'browseNewReleases.html">New Releases</a>'+
				  		'<a class="kidsLink" href="http://' + clientUrl + 'browseKids.html">Kids</a>'+
		  			'</div>'+
		  			...
		  			'<div class="_anonymous loginButtonContainer">'+
		  				'<a><i class="fa fa-user"></i></a>'+
		  			'</div>'+
		  			'<div class="_authenticated mobileAccountMenu">'+
		  				'<a><i class="fa fa-user"></i></a>'+
		  			'</div>'+
		  			'<ul class="mobileAccountDropDownList" style="display:none">'+
		  				'<li class="libraryButtonContainer clearfix"><a cdresource="my_library">My Library</a></li>' +
			      	'<li class="accountButtonContainer clearfix"><a cdresource= "account_information">Account Information</a></li>' +
		        	'<li class="orderButtonContainer clearfix"><a cdresource="order_history">Order History</a></li>' +
		        	'<li class="paymentButtonContainer clearfix"><a cdresource= "payment_methods">Payment Methods</a></li>' +
	...
	$.cd.flex.updateTemplate (
	  ...
	  '<div class="footer clearfix">'+
	  	'<ul>'+
	  		'<li><a id="footerContactButton" href="https://www.eastlink.ca/about/contact.aspx">Contact Us</a></li>'+
	  		'<li><a id="footerHomepageButton" href="http://my.eastlink.ca/customersupport.aspx">Support</a></li>'+
	  		'<li><a id="footerPrivacyPolicyButton">Privacy Policy</a></li>'+
	  		'<li class="no-border noRightBorder"><a id="footerTermsOfUseButton" href="http://www.eastlink.ca/about/termsandconditions.aspx">Legal & Regulatory</a></li>'+
	  	'</ul>'+
	  	'<div class="footerMobile">'+
	  		'<a class="deviceBannerApple" href=""><img src="Content/Assets/app_store_badge.png" /></a>'+
		  	'<a class="deviceBannerAndroid" href=""><img src="Content/Assets/google_play_app.png" /></a>'+
		  '</div>'+
	  '</div>',
	  applyCustomFooter
	);
  ...
  $.cd.flex.updateTemplate (
  	'accountmenu',
	  '<ul class="accountMenu notMobile" style="display:none;">'+
  ...
  $.cd.flex.addTemplate (
	  ...
	  '<div id="sliderlist_{Index}" cdpageid="{PageId}" cdcontenttype="{ContentType}" cdcontentid="{ContentId}" cdcategoryid="{CategoryId}" class="sliderListHeader"><h1 class="featuredContentBucketTitle" cdresource="{Name}">Also Recommended</h1><a class="secondaryButton showAllButton" style="display: {ShowMoreEnabled};"><span cdresource="show_all">Show all</span></a></div><div id="sliderproductlist_{Index}">%products%</div>',
  ...
  $.cd.flex.updateTemplate (
	   'partialproduct',
	   '<li id="productthumb_{Index}" cdproductid="{Id}" cdsubproductid="{SubscriberProductId}" externalSubRef="{ExternalSubscriberProductReference}" externalType="{ExternalSubscriberProductType}" cdproductname="{Name}" cdhtmltarget="{HtmlTarget}" cdstructuretype="{ProductStructureType}" class="product-layout-list-item">'+
	   	'<div class="featuredContentIndividualItem">'+
	   		'<div class="loading" style="display:none;">'+
	   			'<div class="inner-loading">'+
	   				'<span cdresource="loading">'+
	   				'</span>'+
	   			'</div>'+
	   		'</div>'+
	   		...
	   		'<div class="grid-product-image-container">'+
	   			'<div class="hover-product-container">'+
	   				'<div id="productoverlay_{Index}" style="display:none;" class="hover-text-overlay">'+
	   					'<ul class="hover-product-data-container">'+
	   						'<li class="hover-product-title"><a cdid="hoverProductLink_{Index}" id="hoverTitle_{Index}" title="{Name}" cdproductid="{Id}" cdhtmltarget="{HtmlTarget}" cdstructuretype="{ProductStructureType}"><span>{Name}</span></a></li>'+
	   						'<li><div class="hover-product-meta">'+
	   							'<ul>%guidanceRatings%<li class="hover-meta-list"><span class="hover-reference-date">{ReferenceYear}</span></li>'+
	   								'<li cdid="viewingBadgeContainer" cdproductid="{Id}" cdclass="viewingbadges" class="product-view-status-container" style="display:none;"><span class="view-icon {ViewStateCss}"></span><span class="view-status-message">{ViewStatusMessage}</span></li>'+
	   							'</ul>'+
	   						'</div>'+
	   					'</li>'+
	   				'</ul>'+
	   				'<div class="hover-down-arrow-container"><span class="fa fa-chevron-down"></span></div></div>'+
	   				'<img class="hover-product-image" src="{ThumbnailUrl}" alt="{Name}" /></div></div>'+
	   				'<a class="thumbnailTitle">{Name}</a>'+
	   				'</div>'+
	   				'</li>'
	);
	$.cd.flex.updateTemplate (
    ...
    '</ul>' +
  	'</div>',
  	applyCustomAccessPolicies
	);
	$.cd.flex.updateTemplate (
		'accesspolicy',
    '<div class="accessPolicySection" cdpolicytype="{Type}">'+
	    '<ul>' +
	      ...
	      '<li class="availability expiredEnd" style="display:none;"><span class="accessLabel" cdresource="purchased_product_expired">Expired:</span><span class="dateValue">{AccessExpirationDateShortDate} at {AccessExpirationDateShortTime}</span></li>' +
	      '<li class="availability expiredAccess" style="display:none;"><span class="accessLabel" cdresource="purchased_product_expires">Expires:</span><span class="dateValue">{AccessExpirationDateShortDate} at {AccessExpirationDateShortTime}</span></li>' +
...
applyCustomAccessPolicies = function (template, part) {
  var html = "",
      childTemplate = "",
      modelHtml = "";
  		showExpired = false,
  ...
  if (model.PlayAccessPolicy != null && model.PlayAccessPolicy.IsAvailable) {
  	   var date = new Date(model.PlayAccessPolicy.AccessExpirationDateShortDate).toDateString();
    	model.PlayAccessPolicy.AccessExpirationDateShortDate = date.slice(0,-5) + ', ' + date.slice(-4);
  ...
  if (modelHtml.length > 0) { //LB- is this necessary?
    ...
    var applyAccessPolicies = function (policy, policyName, policyContainer) {
			var showExpired = (policy.AfterAvailabilityEndDate && policy.AccessExpirationDate != null) || (policy.AccessSecondsRemaining === 0 && policy.AccessExpirationDate != null);
...
applyCustomActionsJson = function (template, part) {
        ...
        var buildActionButton = function (actionCode, productId, callback, isAvailable, cdid) {
          ...
          //if (($.cd.get_browserInfo().OS == "Mac" && $.cd.get_browserInfo().browser == "Chrome" && $.cd.get_browserInfo().version >= 39) || ($.cd.get_browserInfo().OS == "Windows" && $.cd.get_browserInfo().browser == "Chrome" && $.cd.get_browserInfo().version >= 42)){
          /*if(true){
          	$(actionSelector).on("click",function(){$.cd.showModalDialog('<div class="chromeAlert">Please use another browser, playback is currently not supported on Chrome.</div>',function(){},false);});
          }
          else {
...
applyCustomPricingJson = function (template, part) {
  ...
  for (var i = 0; i < model.PaidPricingPlans.length; i++) {
    ...
    if(child.Name.search('Rent')>=0 || child.Name.search('rent')>=0 || child.Name.search('RENT')>=0){
    	...
    	tempHtml = tempHtml.replace('%RentalPolicy%','Rental Period - ' + policy + '.');
    }
  ...
  if(paidHDHtml != '' && paidSDHtml != ''){
  	$(document).off('click','.pricingPlanHDToggle');
  	$(document).off('click','.pricingPlanSDToggle');
  	...
  	modelHtml = modelHtml.replace("%HDPricingDisplay%","block");
  	modelHtml = modelHtml.replace("%SDPricingDisplay%","none");
  	modelHtml = modelHtml.replace("%pricingPlanSDSelected%","pricingPlanNotAvailable");
  	modelHtml = modelHtml.replace("%pricingPlanHDSelected%","pricingPlanSelected");
  	modelHtml = modelHtml.replace("%pricingPlanSDSelected%","");
  	$(document).on('click','.pricingPlanHDToggle',function(){
			// make sure you only select the correct block
...
applyCustomNavigationMenu = function (template, part) {
    ...
    $.cd.flex.appendToContainer(part, template.html);
    $(document).on('click','.mobileMenuDropDown',function(){
    	$('.mobileMenuDropDownList').toggle();
    	$('.mobileAccountDropDownList').hide();
    });
    $(document).on('click','.mobileAccountMenu',function(){
    	$('.mobileAccountDropDownList').toggle();
    	$('.mobileMenuDropDownList').hide();
    });
    ...
    // MJ: Apply drop shadow
		...
		var indexnav = $('#index .headerWrapper');
		scope.scroll(function() {		
			...
			if (scopeLocation > 0) {
				...
				indexnav.css({
					...
					'-webkit-box-shadow' : '0px 0px 5px 1px #B8B8B8'
				});
			} else {
				nav.css({
...
var defaultsettings = {
  ...
  widevine: {
	...
	/*htmlplayer: {
      hideControls: false,
      defaultVolume: 50,
      templateUrl: "http://" + clientUrl + "Content/templates/htmlplayerui.html",
      pluginUrl: 'HTPL/HTMLPlayer/%htmlplayerversion%/js/ascendon.htmlplayer-2.1.1.min.js',
      //customResourcesUrl: 'https://' + clientUrl + "Scripts/resources.json",
      defaultCaptionLanguage: 'eng',
      defaultAudioLanguage: 'eng',
      hdcpTestFile: 'http://smoothhd.contentdirect.tv/ondemand/HDCP/CDHD.ism/Manifest',
      showMessages: true, 
    ...
    defaultCaptionLanguage: 'eng',
    defaultAudioLanguage: 'eng',
    customResourcesUrl: 'http://' + clientUrl + "Scripts/resources.json",
    hdcpTestFile: 'http://smoothhd.contentdirect.tv/ondemand/HDCP/CDHD.ism/Manifest',
    pluginUrl: 'HTPL/HTMLPlayer/%htmlplayerversion%/js/ascendon.htmlplayer-2.1.0.min.js',
    showMessages: true,
    unsupportedAudioCodecs: ['mp4a.40.0']
  },
	convivaId: null,
	...
	detail: {
          	...
          	afterMethod: function (result) {
          		joinExistingSession(function(){
	        	    ...
	        	    if (hashKeyword == null || hashKeyword == "") {
	          		...
	          		var filterSelection = ContentDirectAPI.getBrowseFilter();
	          		//if (null == filterSelection.match(/\d+/g))
	          		ContentDirectAPI.updateBrowseFilter("CF", env.MoviesCategoryID , true, true);	
	          		filterSelection = 'CF_' + env.MoviesCategoryID + ';';                		
	          		var loadCategoriesAndProducts = ((catId != null && catId.length > 0) || (filterSelection != null && filterSelection != ""));
          	...
          	afterMethod: function (result) {
          		joinExistingSession(function(){
	        	    ...
	        	    if (hashKeyword == null || hashKeyword == "") {
	          		...
	          		var filterSelection = ContentDirectAPI.getBrowseFilter();
	          		//if (null == filterSelection.match(/\d+/g))
	          		ContentDirectAPI.updateBrowseFilter("CF", env.TVCategoryID , true, true);	
	          		filterSelection = 'CF_' + env.TVCategoryID + ';';                		
	          		var loadCategoriesAndProducts = ((catId != null && catId.length > 0) || (filterSelection != null && filterSelection != ""));
      ...
      // Most popular category page
      {
      	name: "browse",
      	resultBatchSize: 40,
      	isCategoryListMode: false,
      	isSecured: false,
      	pathName: "/browsePopular.html",
      	overrideCommands: [
      		{ name: 'AfterInitialized',
          	afterMethod: function (result) {
          		joinExistingSession(function(){
	        	    ...
	        	    if (hashKeyword == null || hashKeyword == "") {
	          		...
	          		var filterSelection = ContentDirectAPI.getBrowseFilter();
	          		//if (null == filterSelection.match(/\d+/g))
	          		ContentDirectAPI.updateBrowseFilter("CF", env.MostPopularCategoryID , true, true);	         
	          		filterSelection = 'CF_' + env.MostPopularCategoryID + ';';      		
	          		var loadCategoriesAndProducts = ((catId != null && catId.length > 0) || (filterSelection != null && filterSelection != ""));
      ...
      },
      {
      	...
      	isCategoryListMode: false,
      	isSecured: false,
      	pathName: "/browseNewReleases.html",
      	overrideCommands: [
      		{ name: 'AfterInitialized',
          	afterMethod: function (result) {
          		joinExistingSession(function(){
	        	    ...
	        	    if (hashKeyword == null || hashKeyword == "") {
	          		...
	          		var filterSelection = ContentDirectAPI.getBrowseFilter();
	          		//if (null == filterSelection.match(/\d+/g))
	          		ContentDirectAPI.updateBrowseFilter("CF", env.NewReleasesCategoryID , true, true);	            		
	          		filterSelection = 'CF_' + env.NewReleasesCategoryID + ';';
	          		var loadCategoriesAndProducts = ((catId != null && catId.length > 0) || (filterSelection != null && filterSelection != ""));
          	...
          	afterMethod: function (result) {
          		joinExistingSession(function(){
	        	    ...
	        	    if (hashKeyword == null || hashKeyword == "") {
	          		...
	          		var filterSelection = ContentDirectAPI.getBrowseFilter();
	          		//if (null == filterSelection.match(/\d+/g))
	          		ContentDirectAPI.updateBrowseFilter("CF", env.KidsCategoryID , true, true);	            		
	          		filterSelection = 'CF_' + env.KidsCategoryID + ';';
	          		var loadCategoriesAndProducts = ((catId != null && catId.length > 0) || (filterSelection != null && filterSelection != ""));
...
$.cd.ready(function () {	
	// Delete login info if close browser
	if ($.cd.getCookie('session')==null){
		document.cookie = "cd_session=true";
		$.cd.deleteCookie('sessionCookie');
		$.cd.get_loginInfo().clear();
		$.cd.deleteCookie(ContentDirect.UI.Cookie.SessionInfo);
		ContentDirectAPI._clear(true, true);
		ContentDirectAPI._end(true);
